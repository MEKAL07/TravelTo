...
<div class="divFormuRegistro">
	...
	<div class="divDerecha">
		<form id="frmRegister" action="{{url('turista/register')}}" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
			...
			<input type="date" name="fechaNacimiento1" id="fechaNacimiento1">
			...
			<br><br>
			{{csrf_field()}}
			<input type="button" name="btnRegistrar" id="btnRegistrar" class="btnR" value="REGISTRARs" onclick="registrarUsuario();"><br><br>
